...
if($cname !=''||$date !='')
{
    if($query = mysql_query("INSERT INTO addpdrive(CompanyName, Date, campusPool, poolcampusVenue, SSLCAgg, PUDIPLOMAgg, MCAAgg, CurrentBacklogs, HistoryBacklogs, BreakStudies, otherDetails)

				...
				<div class="col-md-7 a-banner-bottom-text">
					<div class="jumbotron banner-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					  <h3>Placement and Training Department</h3>
						<h5></span></h5>
						<p>KLE Dr MS Sheshgiri College of Engineering & Technology(KLECET) was established 1979, formely known as K.L.E. Society’s College of Engineering and Technology, Belgaum is one of the premier and sought after technical institution in the North Karnataka. It is under the umbrella of Karnataka Lingayat Education Society, Belgaum. KLECET is a Self-financing, Non-Autonomous and ISO 9001:2008 Certified Institution. It is recognized by AICTE and affiliated to Visvesvaraya Technological University (VTU), Belgaum.. 
						</p>
					</div>
				</div>
				<div class="clearfix"> </div>
		...
		<div class="container">
			...
			<div class="about-bottom-grids">
				<div class="col-md-6 about-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					<h4>What We Offer?</h4>
					<p>The Institute offers bachelors degree courses in 10 disciplines in Engineering viz. AR-Automation & Robotics Engineering ,BT-Bio-technology, CA-Computer Science & Engineering (Artificial Intelligence), BM-Bio-Medical Engineering, CH-Chemical Engineering, CS-Computer Science & Engineering, EC-Electronics & Comm-unication Engineering, EE-Electrical & Electronics Engineering, ME-Mechanical Engineering, VL-Electronics Engineering (VLSI Design & Technology) ,and 03  post graduate courses viz. MCA,MBA,M.Tech,BCA.
					</p>
				</div>
				<div class="col-md-6 about-bottom-left about-bottom-right wow fadeInRight animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					<h4>We Promote</h4>
					<p>KLE Dr MS Sheshgiri College of Engineering and Technology, Belgaum has a placement cell that handles placement and training programmes. The KLESCET Belgaum placement cell makes every effort to ensure that the placement process runs smoothly and efficiently. The KLESCET Belgaum placement office is well equipped with facilities like an auditorium for pre-placement talks and workshops, an online portal for students to submit applications and assess company information, group discussion and interview rooms, and telephone interview and video conferencing facilities.The placement cell also invites companies for the KLESCET Belgaum placement drives.
                         The KLESCET Belgaum also has a training cell that conducts training programmes on quantitative aptitude, critical reasoning, logical reasoning, verbal aptitude, English grammar, resume building, and many more. The KLESCET Belgaum placement cell also assists students in obtaining internships from corporations and invites corporate resource persons to deliver seminars and webinars on a regular basis.
			...
			<div class="team-info">
				...
				<div class="team-grids">
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						<img src="images/HOD sir1.jpg" alt="">
						<h6>Dr V S Malemath</h6>
						<p> HOD of MCA Department</p>
					</div>
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						<img src="images/class teacher1.jpg" alt="">
						<h6>Laxmi Sangolli</h6>
						<p>Class Teacher</p>
					</div>
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						<img src="images/DS MAAM1.jpg" alt="">
						<h6>Aishwarya Huddekar</h6>
						<p> Project Coordinater</p>
					</div>
					<div class="col-md-3 team-grid wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
						<img src="images/DAA maam1.jpg" alt="">
						<h6>Arpita Modagi</h6>
						<p>Project Guide</p>
					</div>
					<div class="clearfix"> </div>
		...
		<div class="copyright">
			...
			<div class="container">
				<div class="copyright-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					 <p>Copyright &copy; 2018  | Developed by
              <a href="http://Projectsworlds.in" target="_parent">Harish</a>
					</p>
				</div>

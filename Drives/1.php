				...
				<div class="col-md-7 a-banner-bottom-text">
					<div class="jumbotron banner-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					  <h3>Placement and Training Department</h3>
						<h5></span></h5>
						<p>KLE Dr.M S Sheshgiri College of Engineering and Technology, Belagavi belongs to KLE Society, a society which has a legacy of 107 years in the field of Education and is one of the largest education societies in the Asia continent.

Established in the year 1979, KLE DR.MSSCET is a Self-financing, Non-Autonomous and an ISO 9001:2015 Certified Institution approved by AICTE, New Delhi. The Institution is recognized under Section 2(f) of UGC Act 1956. The Institute conducts a full range of academic activities in the field of Engineering and Management education covering research, teaching, training, consulting and intellectual infrastructure development. The Institute focuses on holistic development of students by adopting the most innovative and creative dimension to impart quality education and employability skills
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Address</h3>
					<div class="address">
						<p>KLE Technological Univeristy's Dr. M. S. Sheshgiri Campus
							<span>Karnataka Belagavi </span>
						</p>
					</div>
					<div class="phone">
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">KLE Technological Univeristy's Dr. M. S. Sheshgiri Campus</h6>
					<h4>

        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="http://www.projectworlds.in">KLE College Belagavi</a>
                </div>
        ...
        <div class="footer">
			<div class="container">
				...
				<div class="col-md-3 get_in_touch ftr">
					<h3>GET IN TOUCH</h3>
					<p>KLE Technological Univeristy's
                    Dr. M. S. Sheshgiri Campus</p>
					<p>Sheshgiri Angol</p>
					<p>+0831-2443881/82/83</p>
					<a href="mailto:cittumkur@rediffmail.com">principal.mss@kletech.ac.in</a>
				</div>
